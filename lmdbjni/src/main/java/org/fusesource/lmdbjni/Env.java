...
public class Env extends NativeObject implements Closeable {
	 ...
	 * {@link org.fusesource.lmdbjni.LMDBException#MAP_RESIZED}. This function may
	...
	public Transaction createTransaction(Transaction parent, boolean readOnly) {
		...
		checkErrorCode(
				mdb_txn_begin(pointer(), parent == null ? 0 : parent.pointer(), readOnly ? MDB_RDONLY : 0, txpointer));
